...
\section{sko: put a space after your bullets. need to have a space
before the bulleted
list}\label{sko-put-a-space-after-your-bullets.-need-to-have-a-space-before-the-bulleted-list}

\section{whats the usefullness of
markdown?}\label{whats-the-usefullness-of-markdown}
...
\item
  focus on output and conclusions, not code (or the other way around.
  flexible formatting!)
\end{itemize}
...
EPAair\_PM25\_NC2017\_raw\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
data on particulate matter as a metric of air quality\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
ECOTOX\_Neonicotinoids\_Mortality\_raw\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
data on neonicotonoid concentrations\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}

\section{sko notes: good for meta
data}\label{sko-notes-good-for-meta-data}
