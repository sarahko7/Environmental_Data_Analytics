...
> ANSWER: can also use data() for data you can always use in R
...
riverdata$Name <- str_replace(riverdata$Name, "\\[.*\\]", "") # remove anything in square brackets, including the square brackets
